...
4. 在这些候选 lambda 中，选择无量纲 PDE 残差综合指标最小者。
...
BASE_RESULT_DIR = (
    r'D:\PINN\zenodo\POD_deeponet\PI-POD-DeepONet\result\Choice_lamda\train_result_lambda_sweep_ND2'
)
...
# lambda 是整个物理损失的总权重：
#
#     total_loss = data_loss + lambda * pde_loss
#
# 建议：
# 1. 首先使用下面的对数网格进行粗搜索；
...
class PhysicsInformedLoss(nn.Module):
    ...
    总损失：
        ...
        L_total = L_data + lambda_phys * L_pde
